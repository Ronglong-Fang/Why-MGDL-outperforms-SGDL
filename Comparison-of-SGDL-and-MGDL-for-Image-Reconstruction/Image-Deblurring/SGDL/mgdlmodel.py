...
def data_setup(opt):
    ...
    fig_filename = f'Fig/SingleGrade_deblurring_deepbutterfly_CleanImage.png'
    ...
    fig_filename = f'Fig/SingleGrade_deblurring{opt.sigma}_deepbutterfly_BlurredImage.png'
    plt.savefig(fig_filename, format='png', bbox_inches='tight', pad_inches=0.1)
    plt.show()  
...
def analysis(filepath, LossPsnr_print, Fig_print, grade):
    ...
    for grade in range(1, opt.grade+1):
        ...
        if Fig_print:
            ...
            fig_filename = f'Fig/SingleGrade_deblurring{opt.sigma}_deepbutterfly_predGrade{grade}.png'
            plt.savefig(fig_filename, format='png', bbox_inches='tight', pad_inches=0.1)
            plt.show()       
    ...
    if LossPsnr_print:
        ...
        fig_filename = f'Fig/SingleGrade_deblurring{opt.sigma}_deepbutterfly_PSNR.png'
        ...
        plt.xticks([0, 0.5e4, 1e4, 1.5e4, 2e4], fontsize=20)
        plt.tight_layout()
        fig_filename = f'Fig/SingleGrade_deblurring{opt.sigma}_deepbutterfly_Loss.png'
        plt.ticklabel_format(style='sci', axis='x', scilimits=(0, 0))
        plt.savefig(fig_filename, format='png', bbox_inches='tight', pad_inches=0.1)
        plt.show()
