...
def analysis(filepath):
    ...
    fig_filename = f'Fig/SingleGrade_deepbutterfly_Loss.png'
    ...
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    fig_filename = f'Fig/SingleGrade_deepbutterfly_PSNR.png'
    plt.ticklabel_format(style='sci', axis='x', scilimits=(0, 0))
    plt.savefig(fig_filename, format='png', bbox_inches='tight', pad_inches=0.1)
    plt.show()
    ...
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
    fig_filename = f'Fig/SingleGrade_deepbutterfly_pred.png'
    plt.savefig(fig_filename, format='png', bbox_inches='tight', pad_inches=0.1)
    plt.show()

    plt.imshow(data['test_Y'], cmap='gray')
    fig_filename = f'Fig/SingleGrade_deepbutterfly_org.png'
    plt.savefig(fig_filename, format='png', bbox_inches='tight', pad_inches=0.1)
    plt.show()